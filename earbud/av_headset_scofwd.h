...
extern void appScoFwdHeartBeat(void);
extern void appSocHfpFouceSendAPLSIRI(void);
extern void appScoFwdUserConfig(uint8* payload, size_t payload_size);
...
enum av_headset_scofwd_ota_messages
{
    ...
    SFWD_OTA_MSG_CALL_VOICE_SIRI_ENABLE,
    SFWD_OTA_MSG_CALL_VOICE_SIRI_DISABLE,
    SFWD_OTA_MSG_HEART_BEAT,
    
    SFWD_OTA_MSG_AV_PLAY_TOGGLE,
       /*! Notify the earbud that the peer requested a RING */
    SFWD_OTA_MSG_RING,
    SFWD_OTA_MSG_RING_CANCEL,
    ...
    /* Tws Peer sync poweroff */
    SFWD_OTA_MSG_PEER_POWEROFF,
#endif
#if defined(PEER_FORCE_PAIRING)
    SFWD_OTA_MSG_PEER_FORCED_PAIRING,
#endif
#if defined(INCLUDE_EQ)
    SFWD_OTA_MSG_UPDATE_USERCONFIG,
#endif
...
extern void appSocHfpFouceSIRIEnable(void);
extern void appSocHfpFouceSIRIDisable(void);
extern void appSocHfpFouceSendAvPlayToggle(void);
#if defined(TWS_PEER_SYNC_POWEROFF)
void appSocHfpPeerSyncPoweroff(void);
#endif
void appSOCHfpPeerForcedEntryPairing(void);
extern void uiPeerReadytoForcedPairing(void);
