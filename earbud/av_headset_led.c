...
void appled_DUT_Mode_Led_open(void)
{
#ifdef LED_USE_PIOS
    /* white LED always turn on */
    PioSetMapPins32Bank(LED_1_BANK, LED_1_PIO_MASK, LED_1_PIO_MASK);
    PioSetDir32Bank(LED_1_BANK, LED_1_PIO_MASK, LED_1_PIO_MASK);
    PioSet32Bank(LED_1_BANK, LED_1_PIO_MASK, 1);
#endif
}
