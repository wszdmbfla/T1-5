...
/*! \brief Send volume up command
*/
void appAvVolumeUp(void){
    appAvVolumeStart(8);
...
void appAvForward(void)
{
    ...
    appAvRemoteControl(opid_forward, 0, FALSE, 0);
...
void appAvBackward(void)
{
    ...
    appAvRemoteControl(opid_backward, 0, FALSE, 0);
