...
static uint8 toPercentage(uint16 voltage)
{
    ...
    if(voltage >= 4150)
        ...
        precentage = 90;
        sig_precent = (voltage -4000)/15;
    }
    else if(voltage >= 3925){
        precentage = 80;
        sig_precent = (voltage -3925)/8;
    }
    else if(voltage >= 3850){
        precentage = 70;
        sig_precent = (voltage -3850)/8;
    }
    else if(voltage >= 3790){
        precentage = 60;
        sig_precent = (voltage -3790)/6;
    }
    else if(voltage >= 3760){
        precentage = 50;
        sig_precent = (voltage -3760)/3;
    }
    else if(voltage >= 3730){
        precentage = 40;
        sig_precent = (voltage -3730)/3;
    }
    else if(voltage >= 3670){
        precentage = 30;
        sig_precent = (voltage -3670)/6;
    }
    else if(voltage >= 3550){
        precentage = 20;
        sig_precent = (voltage -3550)/12;
    }
    else if(voltage >= 3400){
        precentage = 10;
        sig_precent = (voltage -3400)/15;
    }
    else if(voltage >= 3200){
        precentage = 0;
        sig_precent = (voltage -3200)/20;

    }

    precentage += sig_precent;
