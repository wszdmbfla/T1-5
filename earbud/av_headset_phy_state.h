...
typedef enum
{
    ...
    PHY_STATE_INTERNAL_IN_CASE_RECHECK,
};
...
#ifdef INCLUDE_UART
extern void PilAppUARTInit(void);
#endif

#if defined(INCLUDE_TAP_SENSOR)
void TapSensorInit(void);
#endif
extern void appPhyStateInCaseReCheckEvent(void);
