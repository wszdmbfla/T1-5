...
/*! User PSKEY to store APP configuration */
#define PS_APP_CONFIG           (2)

/*! User PSKEY to proximity configuration */
#define PS_PROXIMITY_CONFIG     (3)

#define PS_SW_VERSION_CONFIG           (5)

/*! User PSKEY to store power off reason ,defualt 0 auto power on */
#define PS_USER_POWEROFF_CONFIG           (6)

#if defined(CUSTOMER_DUT)
/*! User PSKEY to store DUT mode ,1 : dut mode ,other is not  */
#define PS_USER_DUT_MODE        (7)
#endif

#if defined(INCLUDE_EQ)
#define PS_USER_EQ_VERIFY       (8)
#endif
...
#endif
#ifdef INCLUDE_TAP_SENSOR
    TapSensorTaskData   tapsensor;              /*!< Task information for tap sensor */
#endif
...
#ifdef INCLUDE_UART
#define appGetUart()   (&globalApp.UART_Task)
#endif

#ifdef INCLUDE_TAP_SENSOR
#define appGetTapSensor()   (&globalApp.tapsensor)
#endif
