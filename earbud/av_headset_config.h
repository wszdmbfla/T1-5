...
/*! check device name */
#define APP_CHECK_DEV_NAME_VALIDATION
...
#define appConfigPeerPairingTimeout()       (60) //(120)
/*! Timeout in seconds for user initiated handset pairing */
#define appConfigHandsetPairingTimeout()    (180) //(120)
...
#define appConfigAutoPeerPairingTimeout()       (60) //(0)
/*! Timeout in seconds for automatic handset pairing */
#define appConfigAutoHandsetPairingTimeout()    (180) //(300)

/*! Maximum number of attempts to try pairing with a handset after authentication failure */ 
#define MAX_NUM_PAIRING_ATTEMPTS 4 
#define PAIRING_RETRY_ALLOWED(NB_ATTEMPT) ( ((MAX_NUM_PAIRING_ATTEMPTS-NB_ATTEMPT) > 0) ? TRUE:FALSE) 
...
/*! The page timeout multiplier for Handsets after link-loss.
    Multiplier should be chosen carefully to make sure total page timeout doesn't exceed 0xFFFF */
//#define appConfigHandsetLinkLossPageTimeoutMultiplier() (4)       // 4-> 41S
#define appConfigHandsetLinkLossPageTimeoutMultiplier() (18)      //   180S
...
#define appConfigMinVolumedB() (-59)          // default -45

/*! Maximum volume gain in dB */
#define appConfigMaxVolumedB() (-14)//(-10)   // default 0

/*! Default volume gain in dB */
#define appConfigDefaultVolumedB() (-19)
...
#define appConfigBatteryVoltageOk()         (3450)  //(3600)
#define appConfigBatteryVoltageLow()        (3360)  // 10%
#define appConfigBatteryVoltageCritical()   (3200)  //  %5
//!@}
...
/*! The proximity sensor configuration */
extern const TapSensorConfig tap_sensor_config;
/*! Returns the proximity sensor configuration */
#define appConfigTapSensor() (&tap_sensor_config)
#endif /* INCLUDE_PROXIMITY */
...
//#define PEER_FORCE_PAIRING
//#define UI_LP_8S_AND_DOUBLECLICK_FACTORYRESET    /* Long press 8S and double click enter factory reset */
