...
enum
{
    ...
    AV_SEID_AAC_STEREO_TWS_SNK, /*!< Stereo TTP AAC Sink endpoint for peer earbud receiving TWS */
    ...
    AV_SEID_AAC_STEREO_TWS_SRC, /*!< Stereo TTP AAC Source endpoint for earbud forwarding TWS */
...
extern void appAvVolumeDown(void);
extern void appAvVolumeUp(void);
...
extern avInstanceTaskData *appAvInstanceReplaceDisconnectedHandset(const bdaddr *bd_addr);
