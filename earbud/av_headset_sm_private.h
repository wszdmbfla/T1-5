...
enum sm_internal_message_ids
{
    ...
    SM_INTERNAL_RECONNECT_HANDSET_FAILED,          /*!< out of case reconnect handset failed */
    ...
    SM_INTERNAL_CONNECT_LINKLOSS_HANDSET,          /*!< lhtadd : connect handset because of handset linkloss */
};
